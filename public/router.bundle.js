...
var browserRouter = _react.default.createElement(_reactRouterDom.BrowserRouter, null, _react.default.createElement(_Search.default, null));

(0, _reactDom.render)(browserRouter, document.getElementById('root'));
...
var _SearchByDesigner = _interopRequireDefault(__webpack_require__(78));

var _SearchByMerchant = _interopRequireDefault(__webpack_require__(79));

var _SearchByMoment = _interopRequireDefault(__webpack_require__(80));

var _SearchByUser = _interopRequireDefault(__webpack_require__(81));

var _SearchByWord = _interopRequireDefault(__webpack_require__(82));
...
function (_Component) {
  ...
  function Search() {
    ...
    _this = _possibleConstructorReturn(this, (Search.__proto__ || Object.getPrototypeOf(Search)).call(this));
    _this.state = {
      words: [],
      hashtags: [],
      users: [],
  ...
  _createClass(Search, [{
    key: "fetchInputValue",
    value: function fetchInputValue(inputValue) {
      var _this2 = this;

      fetch('https://modesens.com/hint2/?txt=' + inputValue, {
        'method': 'GET'
    ...
    value: function handleChange(event) {
      ...
      this.setState({
        ...
        _this3.fetchInputValue(_this3.state.value);
      });
    }
  }, {
    ...
    value: function render() {
      ...
      }, _react.default.createElement(_SearchByWord.default, {
        words: this.state.words
      }), _react.default.createElement(_SearchByDesigner.default, {
        designers: this.state.designers
      }), _react.default.createElement(_SearchByUser.default, {
        users: this.state.users
      }), _react.default.createElement(_SearchByMoment.default, {
        hashtags: this.state.hashtags
      }), _react.default.createElement(_SearchByMerchant.default, {
...
var SearchByDesigner =
/*#__PURE__*/
function (_Component) {
  _inherits(SearchByDesigner, _Component);

  function SearchByDesigner() {
    _classCallCheck(this, SearchByDesigner);

    return _possibleConstructorReturn(this, (SearchByDesigner.__proto__ || Object.getPrototypeOf(SearchByDesigner)).call(this));
  }

  _createClass(SearchByDesigner, [{
    key: "render",
    value: function render() {
      return _react.default.createElement("div", {
        className: "search-by"
      }, _react.default.createElement("div", {
        className: "search-by-designers"
      }, !this.props.designers ? _react.default.createElement("div", null) : this.props.designers.map(function (designer, i) {
        return _react.default.createElement(_reactRouter.Link, _defineProperty({
          to: "/designer/".concat(designer.url),
          key: 'search-designer' + i,
          className: "search-by-designer-item"
        }, "key", i), _react.default.createElement("div", {
          className: "search-by-imgcontainer"
        }, _react.default.createElement("img", {
          src: designer.logo
        })), _react.default.createElement("div", {
          className: "search-by-img-intro"
        }, designer.locname));
      })));
    }
  }]);

  return SearchByDesigner;
}(_react.Component);

var _default = SearchByDesigner;
exports.default = _default;
...
var SearchByMerchant =
/*#__PURE__*/
function (_Component) {
  _inherits(SearchByMerchant, _Component);

  function SearchByMerchant() {
    _classCallCheck(this, SearchByMerchant);

    return _possibleConstructorReturn(this, (SearchByMerchant.__proto__ || Object.getPrototypeOf(SearchByMerchant)).call(this));
  }

  _createClass(SearchByMerchant, [{
    key: "render",
    value: function render() {
      return _react.default.createElement("div", {
        className: "search-by"
      }, _react.default.createElement("div", {
        className: "search-by-merchants"
      }, !this.props.merchants ? _react.default.createElement("div", null) : this.props.merchants.map(function (merchant, i) {
        return _react.default.createElement(_reactRouter.Link, {
          to: "/product/store/".concat(merchant.name),
          key: 'search-merchant' + i,
          className: "search-by-merchant-item"
        }, _react.default.createElement("div", {
          key: i,
          className: "search-by-merchant-item"
        }, _react.default.createElement("div", {
...
/*#__PURE__*/
function (_Component) {
  _inherits(SearchByMoment, _Component);

  function SearchByMoment() {
    _classCallCheck(this, SearchByMoment);

    return _possibleConstructorReturn(this, (SearchByMoment.__proto__ || Object.getPrototypeOf(SearchByMoment)).call(this));
  }

  _createClass(SearchByMoment, [{
    key: "render",
    value: function render() {
      return _react.default.createElement("div", {
        className: "search-by"
      ...
      }, "MOMENTS"), _react.default.createElement("div", {
        className: "search-by-momentstags"
      }, !this.props.hashtags ? _react.default.createElement("div", null) : this.props.hashtags.map(function (tag, i) {
        return _react.default.createElement(_reactRouter.Link, {
          to: "/moment/".concat(tag),
          key: 'search-moment-link' + i
        }, _react.default.createElement("div", {
          className: "search-by-momentstag-item",
          key: 'search-moment' + i
        }, tag));
      })));
    }
  ...
  return SearchByMoment;
}(_react.Component);

var _default = SearchByMoment;
exports.default = _default;
...
/*#__PURE__*/
function (_Component) {
  _inherits(SearchByUser, _Component);

  function SearchByUser() {
    _classCallCheck(this, SearchByUser);

    return _possibleConstructorReturn(this, (SearchByUser.__proto__ || Object.getPrototypeOf(SearchByUser)).call(this));
  }

  _createClass(SearchByUser, [{
    key: "render",
    value: function render() {
      return _react.default.createElement("div", {
        className: "search-by"
        ...
        className: "search-by-users"
      }, !this.props.users ? _react.default.createElement("div", null) : this.props.users.map(function (user, i) {
        return _react.default.createElement(_reactRouter.Link, {
          to: "/closet/".concat(user.username, "/").concat(user.uid),
          key: 'search-user' + i,
          className: "search-by-user-item"
        }, _react.default.createElement("div", {
          className: "search-by-imgcontainer-user"
        }, _react.default.createElement("p", {
...
/*#__PURE__*/
function (_Component) {
  _inherits(SearchByWord, _Component);

  function SearchByWord() {
    _classCallCheck(this, SearchByWord);

    return _possibleConstructorReturn(this, (SearchByWord.__proto__ || Object.getPrototypeOf(SearchByWord)).call(this));
  }

  _createClass(SearchByWord, [{
    key: "render",
    value: function render() {
      return _react.default.createElement("div", {
        className: "search-by"
        ...
        className: "search-title"
      }, "Search Products by Keywords"), _react.default.createElement("div", {
        className: "search-by-words"
      }, !this.props.words ? _react.default.createElement("div", null) : this.props.words.map(function (word, i) {
        return _react.default.createElement("div", {
          key: 'seachword' + i,
          className: "search-by-word-item"
        }, word);
      })));
    }
  }]);
